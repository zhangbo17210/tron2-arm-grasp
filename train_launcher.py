"""
Root-level launcher for gm-run.
Sets up imports and delegates to the actual training code.
"""
import sys
import os

# Add repo root and legged_gym to path
repo_root = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, repo_root)

# Now import the actual training modules
